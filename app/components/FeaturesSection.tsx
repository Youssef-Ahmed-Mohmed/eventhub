                ...
                <div className="grid gap-6 md:grid-cols-3">
                    {features.map((feature, index) => {
                        ...
                        return (
                            ...
                            >
                                {/* Glow */}
                                <div className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-purple-500/10 blur-3xl transition duration-500 group-hover:bg-purple-500/20" />
                                ...
                                <motion.div
                                    ...
                                    className="relative flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-purple-300"
                                >
                                    <Icon size={25} />
                                </motion.div>
